...
from apps.core.models import Account,Account_detail
...
class User_master_form(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(User_master_form, self).__init__(*args, **kwargs)				   
    ...
    def clean(self):
        cleaned_data = super(User_master_form, self).clean()
